  ...
  return (
    ...
    <div className='bg-violet-300 w-fit rounded-md p-2'>
      <div className='flex items-center space-x-4'>
        <img src={avartar} alt="demo" className='object-cover w-[120px] h-[120px] rounded-full border border-solid border-white-rgb'/>
        ...
        <SidebarIcon icon={<FaRegCircle size="14" color='gray'/>}/>
        <p>{user?.role}</p>
        </div>
        </div>
        </div>
