      ...
      <div className=" pb-8">
        <div className="flex justify-between items-center mb-6">
          <div className="flex gap-4 items-center">
            <h1 className="font-sans font-semibold text-lg cursor-pointer">
              Featured
            </h1>
            <SidebarIcon
              icon={<GrLinkNext size="18" className="cursor-pointer" />}
            />
            <h1 className="font-sans font-semibold text-lg cursor-pointer">
            ...
            {ListComics.map((comics: any, index: any) => (
              <div key={index} className="">
                ...
                >
                  ...
                  />
                  <p className="font-sans text-describes-rgb cursor-pointer">
                    {comics.name}
                  </p>
                </div>
              </div>
